...
class ShoppingCart:
    ...
    def remove_laptop(self, index):
        laptop = self.laptops[index]
        del self.laptops[index]
        laptop_price = laptop.calculate_price()
        self.total -= laptop_price

    def get_laptop_by_index(self, index):
        return self.laptops[index]
    
    def get_num_laptops(self):
        return len(self.laptops)
    
    def update_laptop_at_index(self, index, ram, gpu):
        laptop = self.laptops[index]
        laptop_price = laptop.calculate_price()
        self.total -= laptop_price
        laptop.ram = ram
